...
namespace vs{
  //All the internal FLTK enumerations which must be public-facing

  constexpr const char * ui_tree::fl_align_pos_s(Fl_Align v){
  ...
  Fl_Align ui_tree::fl_align_pos_i(const char* v){
  ...
  constexpr const char * ui_tree::fl_align_image_s(Fl_Align v){
  ...
  Fl_Align ui_tree::fl_align_image_i(const char* v){
  ...
  constexpr const char * ui_tree::fl_align_clip_s(Fl_Align v){
    if(v==FL_ALIGN_CLIP){return "clip";}
    if(v==0){return "no-clip";}
    return nullptr;
  }

  Fl_Align ui_tree::fl_align_clip_i(const char* v){
  ...
  constexpr const char * ui_tree::fl_align_wrap_s(Fl_Align v){
    if(v==FL_ALIGN_CLIP){return "clip";}
  ...
  Fl_Align ui_tree::fl_align_wrap_i(const char* v){
    if(strcmp(v,"clip")==0){return FL_ALIGN_CLIP;}
  ...
  constexpr const char * ui_tree::fl_align_inside_s(Fl_Align v){
    if(v==FL_ALIGN_INSIDE){return "inside";}
    if(v==0){return "outside";}
    return nullptr;
  }

  Fl_Align ui_tree::fl_align_inside_i(const char* v){
  ...
  constexpr const char* ui_tree::fl_font_s(Fl_Font v){
  ...
  Fl_Align ui_tree::fl_font_i(const char* v){
