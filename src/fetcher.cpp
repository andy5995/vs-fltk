...
std::tuple<resolve_path::reason_t::t,cache::xml_tree_t, scoped_rpath_t> fetcher_xml(resolve_path& base, resolve_path::from_t from,const char* src, bool promote, bool preserve){
    //TODO: implement
}
